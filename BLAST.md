...
1. Initialize Project Memory
  Create:
      ...
      findings.md -> Research, discovered, constraints
      progess.md -> What was done, errors, tests, results
   Initialize gemini.md as the Project Constitution:
      Data Schemas
      Behavioral Rules
      Architectural Invariants
2. Halt Executions you are strictly forbidden from writing scripts in tools/ until:
    Discovery questions are answered
    The Data Schemas is defined in gemini.md
